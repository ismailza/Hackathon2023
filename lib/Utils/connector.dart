...
class Connector {
  ...
  static String blockchainUrl = "https://sepolia.infura.io/v3/69ccfe0458774e1ab6cfea80dc6ef548";
  ...
  static Future<DeployedContract> getContractPatient() async {
    ...
    String contractAddress = "0xc3Dab1a3DAb5b1e7A9eBc81789bEa22A7F58ACED";
  ...
  static Future<DeployedContract> getContractDoctor() async {
    ...
    String contractAddress = "0xC68138e11061d141C2DEBb1aA9c4BC21aDb28E38";
  ...
  static Future<bool> addAuthorization(EthereumAddress doc, EthereumAddress pat, String privateKey) async {
